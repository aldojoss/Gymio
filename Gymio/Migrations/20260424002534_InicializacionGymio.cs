...
{
    /// <inheritdoc />
    public partial class InicializacionGymio : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiasCongeladosRestantes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuscripcionesClientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuscripcionesClientes_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuscripcionesClientes_Planes_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuscripcionesClientes_ClienteId",
                table: "SuscripcionesClientes",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_SuscripcionesClientes_PlanId",
                table: "SuscripcionesClientes",
                column: "PlanId");
